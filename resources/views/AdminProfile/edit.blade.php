...
<head>
    ...
    <?php
        ...
        if(old('category') != null) $category = old('category');
        if(old('full_text') != null) $full_text = old('ful_text');
    ?>
...
<header class="container bg-warning">
    <div class="row justify-content-center">
        <div class="col-10  text-center">Редактирование статьи</div>
    </div>
</header>
...
<main class="container">
    <div class="row justify-content-center">
        <div class="col-11 ml-5">
            <form method="post" action="{{route('articles.update', ['user' => $user->id,
              'article' => $article->id])}}"
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        <option>{{$article->category_name}}</option>
                ...
                <div class="form-group">
                    ...
                    <textarea name="full_text" id="text" class="form-control" required
                              placeholder=" Напишите статью...">{{$full_text}}</textarea>
                </div>
                ...
                <div class="form-group">
                    <label>Главное фото:
                        @if($errors->has('photo'))
                            ...
                            @endforeach
                        @endif</label>
                    <input type="file" name="photo" class="ml-5">
                </div>
