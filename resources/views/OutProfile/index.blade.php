  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #65696B;">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
                <a class="nav-link @if(isset($active_pop)){{$active_pop}}@endif" href="/">Популярное</a>
              </li>
              <li class="nav-item">
                <a class="nav-link @if(isset($active_new)){{$active_new}}@endif" href="/new_">Новое</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item"
                       href="<?php if(isset($active_pop)) echo '/'; else echo '/new_'; ?>">
                        <option>Всё</option>
                    </a>
                    ...
                    <a class="dropdown-item"
                      @if(isset($active_pop))
                      href="{{route('category_out', ['page' => 1,'category' => $category1->id])}}"
                      @endif

                      @if(isset($active_new))
                      href="{{route('category_out_new', ['page' => 1,'category' => $category1->id])}}"
                      @endif>
        ...
        <!-- регистрация + авторизация-->
          <div id="reg-ent">
            <a href="/regist">Регистрация</a><br>
            <a href="{{route('entry')}}">Авторизация</a>
          </div>
