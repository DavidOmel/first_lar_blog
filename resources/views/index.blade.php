...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <a href="/regist"><button id="S1">Регистрация</button></a><br/><br/>
        <a href="/authent"><button id="S2">Авторизация</button></a>
    </div>
</nav>
    ...
    <div class="jumbotron">
        <div class="container">
            <h1 class="display-3">Hello, <?php
                $appeal = null;
                if(!(isset($user->name))){$appeal = 'world';}
                else $appeal = $user->name;
